...
Public Class UpdateTemplateVersion
    ...
    Public Overrides Function Execute() As Boolean
        Try
            ...
            For Each template In VSTemplatesToRewrite
                ...
                Dim newDirectory = SaveTemplateXml(
                    templateXml,
                    template.ItemSpec,
                    IntermediatePath,
                    template.GetMetadata("OutputSubPath"),
                    _newVSTemplates)
    ...
    Public Sub CopyExtraFile(newDirectory As String, originalDirectory As String, extraFile As String)
        ...
        Try
            ...
            Dim copyFileInfo As New FileInfo(fullPath) With {
                .IsReadOnly = False
            }
        Catch ex As Exception
            ' Do nothing if there is a permissions problem
        End Try
    End Sub

    Private Declare Auto Function PathRelativePathTo Lib "shlwapi.dll" (pszPath As StringBuilder,
                                                                        pszFrom As String,
                                                                        dwAttrFrom As Integer,
                                                                        pszTo As String,
                                                                        dwAttrTo As Integer) As Boolean
    ...
    Private Function SaveTemplateXml(xml As XDocument,
                                     templatePath As String,
                                     intermediatePath As String,
                                     metaDataValue As String,
                                     ByRef newItems As List(Of ITaskItem)) As String
